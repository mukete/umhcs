...
<div class="container">
  <div class="row">
    <div class="col-lg-8 col-lg-offset-4">
      <h4 class="hs_heading">Please create account.</h4>
      <p>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <select name="type" required class="form-control input-sm">
                  <option value="PATIENT">Patient</option>
                  <option value="PHYSICIAN">Physician</option>
                </select>
                <span class="badge alert-danger">{{ ($errors->has('type') ? $errors->first('type') : '') }}</span>
              </div>
